...
| Google Cloud Run MCP | Der Google Cloud Run MCP Server ermöglicht es KI-Agenten, Anwendungen direkt aus | Stabil | Gering | Kein EOL bekannt | [google-cloud-run-mcp/README.md](google-cloud-run-mcp/README.md) |
| Google Cloud SDK (gcloud) | Das Google Cloud SDK enthält das `gcloud` Kommandozeilenwerkzeug, mit dem Sie | Stabil (Aktiv gewartet, Stand April 2026) | Gering | Kein EOL bekannt | [google-cloud-sdk/README.md](google-cloud-sdk/README.md) |
| Kubernetes (kubectl) | Kubernetes ist ein Open-Source-System zur Automatisierung der Bereitstellung, Skalierung und Verw... | Stabil | Gering | Kein EOL bekannt | [kubernetes/README.md](kubernetes/README.md) |
| Vast ai sdk | Vast-ai-sdk ist das offizielle Python-SDK und Kommandozeilenwerkzeug (CLI) für | Stabil | Gering | Kein EOL bekannt | [vast-ai-sdk/README.md](vast-ai-sdk/README.md) |
| Xvfb | Xvfb (X Virtual Framebuffer) ist ein Display-Server, der das X11-Protokoll | Stabil | Gering | Kein EOL bekannt | [xvfb/README.md](xvfb/README.md) |
