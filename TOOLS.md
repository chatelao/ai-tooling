...
| Animation | Krita | Digitales Malwerkzeug mit Unterstützung für 2D-Animationen | `sudo apt install krita` | [Link](https://krita.org/) | [Link](factsheets/animation/krita/README.md) |
...
| CAD/3D | MeshLab | Bearbeitung von 3D-Meshes | `sudo apt install meshlab` | [Link](https://www.meshlab.net/) | [Link](factsheets/cad-3d/meshlab/README.md) |
| CAD/3D | OpenSCAD | Der Programmierer unter den 3D-CAD-Modellierern | `sudo apt install openscad` | [Link](https://openscad.org/) | [Link](factsheets/cad-3d/openscad/README.md) |
...
| Firmware-Analyse | Ghidra | Software-Reverse-Engineering-Framework | [Download](https://ghidra-re.org/) | [Link](https://ghidra-re.org/) | [Link](factsheets/firmware-analyse/ghidra/README.md) |
| Firmware-Analyse | GNU Binutils | Sammlung von GNU-Werkzeugen zur Manipulation von Binärdateien (Assembler, Linker, etc.) | `sudo apt install binutils` | [Link](https://www.gnu.org/software/binutils/) | [Link](factsheets/firmware-analyse/gnu-binutils/README.md) |
| Firmware-Analyse | Hexdump | Anzeige von Dateiinhalten in verschiedenen Formaten (Hexadezimal, Dezimal, Oktal, ASCII) | `sudo apt install bsdextrautils` | [Link](https://www.kernel.org/pub/linux/utils/util-linux/) | [Link](factsheets/firmware-analyse/hexdump/README.md) |
| Firmware-Analyse | PANDA | Plattform für Architektur-neutrale dynamische Analyse | `git clone https://github.com/panda-re/panda.git` | [Link](https://panda.re/) | [Link](factsheets/firmware-analyse/panda/README.md) |
| Firmware-Analyse | Radare2 | Reverse-Engineering-Framework | `sudo apt install radare2` | [Link](https://www.radare.org/) | [Link](factsheets/firmware-analyse/radare2/README.md) |
| Firmware-Analyse | YARA | Musterabgleich für Malware-Forscher | `sudo apt install yara` | [Link](https://virustotal.github.io/yara/) | [Link](factsheets/firmware-analyse/yara/README.md) |
| Hardware-Simulation | Renode | Emulator für Hardware-Systeme | [Download](https://renode.io/#download) | [Link](https://renode.io/) | [Link](factsheets/hardware-simulation/renode/README.md) |
| Infrastruktur | Vast.ai SDK | Management von GPU-Instanzen | `pip install vastai` | [Link](https://github.com/Vast-ai/vast-python) | [Link](factsheets/infrastruktur/vast-ai-sdk/README.md) |
| Infrastruktur | Xvfb | Virtueller Framebuffer für X11 (Headless-Grafik) | `sudo apt install xvfb` | [Link](https://www.x.org/releases/X11R7.6/doc/man/man1/Xvfb.1.xhtml) | [Link](factsheets/infrastruktur/xvfb/README.md) |
